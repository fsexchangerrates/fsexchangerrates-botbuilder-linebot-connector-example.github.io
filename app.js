...
bot.dialog('/', [
    function (s) { return __awaiter(_this, void 0, void 0, function () {
        var m, msg;
        return __generator(this, function (_a) {
            m = new builder.Message(s)
                .text("hello world")
            ...
            s.send(new builder.Message(s)
                .addAttachment(new botbuilder_linebot_connector_1.Sticker(s, 1, 1))
                .addAttachment(new botbuilder_linebot_connector_1.Location(s, "my test", "中和", 35.65910807942215, 139.70372892916203))
            ...
            // ).addAttachment(
            // new builder.VideoCard(s).media([{
            //     url: "https://fs-preview.kfs.io/201307/094qYOwimTo30mpLw_FUBtFAQnzkfdWeKlkkrtwLN8CDky3dVmk=?__gda__=1523963806_d2d3184a9f940c34939b001546968e0c",
            //     profile: "music"
            // }])
            //     .image(builder.CardImage.create(s, 'https://imagelab.nownews.com/?w=1080&q=85&src=http://s.nownews.com/11/b9/11b93df1ec7012f4d772c8bb0ac74e10.png'))
            ).addAttachment(new builder.AudioCard(s).media([{
                    url: "https://fs-preview.kfs.io/201307/094qYOwimTo30mpLw_FUBtFAQnzkfdWeKlkkrtwLN8CDky3dVmk=?__gda__=1523963806_d2d3184a9f940c34939b001546968e0c",
                    profile: "music"
                }])).addAttachment(new builder.MediaCard(s).image(builder.CardImage.create(s, 'https://imagelab.nownews.com/?w=1080&q=85&src=http://s.nownews.com/5d/6b/5d6b74b674e643f522ed68ef83053a1f.JPG'))));
            msg = new builder.Message(s);
